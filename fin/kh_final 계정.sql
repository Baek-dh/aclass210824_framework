...
WHERE BOARD_NO = 509
AND IMG_LEVEL IN (0,2,1,3,2,2,2,2,2);
...
AND BOARD_TITLE LIKE '%' || '1' || '%' -- 제목
--AND BOARD_CONTENT LIKE '%' || '1' || '%'; -- 내용
--AND (BOARD_TITLE LIKE '%' || '1' || '%' 
--  OR BOARD_CONTENT LIKE '%' || '1' || '%'); -- 제목 + 내용 
--AND MEMBER_NM LIKE '%' || '유저이' || '%'; -- 작성자 검색
AND CATEGORY_CD = 3;
...
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1', SYSDATE, 509, 1, 1, NULL);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식1', SYSDATE, 509, 1, 1, 1);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식2', SYSDATE, 509, 1, 1, 1);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식3', SYSDATE, 509, 1, 1, 1);

INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모2', SYSDATE, 509, 1, 1, NULL);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모3', SYSDATE, 509, 1, 1, NULL);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모4', SYSDATE, 509, 1, 1, NULL);

INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모2-자식1', SYSDATE, 509, 1, 1, 5);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모2-자식2', SYSDATE, 509, 1, 1, 5);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모2-자식3', SYSDATE, 509, 1, 1, 5);


INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식3-손자1', SYSDATE, 509, 1, 1, 4);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식3-손자2', SYSDATE, 509, 1, 1, 4);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식3-손자3', SYSDATE, 509, 1, 1, 4);

COMMIT;


-- 계층형 쿼리(START WITH,  CONNECT BY,  OREDER SIBLINGS BY )
...
-- CONNTENT BY PRIOR 자식컬럼 = 부모컬럼  (부모 -> 자식  계층 구조)
--                  REPLY_NO    PARENT_REPLY_NO

-- CONNTENT BY PRIOR 부모컬럼 = 자식컬럼  (자식 -> 부모  계층 구조)
--                PARENT_REPLY_NO  REPLY_NO    

-- OREDER SIBLINGS BY + 컬럼명 : 계층 구조를 쉽게 정렬
...
INSERT INTO CHAT_ROOM_JOIN VALUES(2/*회원번호*/, 1/*채팅방번호*/);




-- 채팅방 생성
INSERT INTO CHAT_ROOM VALUES(SEQ_CR_NO.NEXTVAL, '테스트2', DEFAULT, 2/*회원번호*/);

-- 채팅방 참여
INSERT INTO CHAT_ROOM_JOIN VALUES(1/*회원번호*/, 2/*채팅방번호*/);
INSERT INTO CHAT_ROOM_JOIN VALUES(2/*회원번호*/, 2/*채팅방번호*/);
INSERT INTO CHAT_ROOM_JOIN VALUES(3/*회원번호*/, 2/*채팅방번호*/);
...
SELECT COUNT(*) FROM CHAT_ROOM_JOIN WHERE CHAT_ROOM_NO = 2;
